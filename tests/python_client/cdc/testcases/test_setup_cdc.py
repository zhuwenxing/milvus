...
class TestCDCTopologySetup(TestCDCSyncBase):
    ...
    def test_normal_topology_setup(self, upstream_client, downstream_client,
    ...
    def test_switch_upstream_downstream(self, upstream_client, downstream_client,
                                        upstream_uri, downstream_uri, upstream_token, downstream_token,
                                        source_cluster_id, target_cluster_id, pchannel_num):
    ...
    def test_invalid_topology_structures(self, upstream_client, downstream_client,
                                         upstream_uri, downstream_uri, upstream_token, downstream_token,
